cmd_scripts/mod/modpost.o := gcc -Wp,-MD,scripts/mod/.modpost.o.d -O2 -I/openwrt/CC/staging_dir/host/include -I/openwrt/CC/staging_dir/host/usr/include -Wall -Wmissing-prototypes -Wstrict-prototypes   -I/openwrt/CC/staging_dir/host/include -I./tools/include  -c -o scripts/mod/modpost.o scripts/mod/modpost.c
